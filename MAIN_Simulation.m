...
% % create a new pair of axes inside current figure
% axes('position',[.65 .275 .2 .15])
% box on % put box around new pair of axes
% indexOfInterest = (out.tout < 2.5 & out.tout > 2); % range of t near perturbation
% plot(out.tout(indexOfInterest), simulation.rho2b(indexOfInterest), 'color', colorblind(6,:), 'linewidth', 1.5) % plot on new axes
% axis tight